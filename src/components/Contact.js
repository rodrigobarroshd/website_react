...
import contactImg from "../assets/img/team.svg";
import 'animate.css';
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} className="px-1">
                      <textarea rows="6" value={formDetails.message} placeholder="Assunto" onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
